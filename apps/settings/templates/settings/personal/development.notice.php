	...
	<p class="social-button">
		<?php print_unescaped(str_replace(
			...
			[
				...
				'<a target="_blank" aria-label="{facebooktext}" rel="noreferrer noopener" href="https://www.accel-tech">',
				'<a target="_blank" aria-label="{xtext}" rel="noreferrer noopener" href="https://www.accel-tech">',
				'<a target="_blank" aria-label="{mastodontext}" rel="noreferrer noopener" href="https://www.accel-tech">',
				'<a target="_blank" aria-label="{rsstext}" rel="noreferrer noopener" href="https://www.accel-tech">',
				'<a target="_blank" aria-label="{mailtext}" rel="noreferrer noopener" href="https://www.accel-tech">',
				'</a>',
